...
__device__ __constant__ int64_t d_alp_fact[19] = {
...
__device__ __constant__ float d_alp_frac_f32[11] = {
...
__device__ __constant__ double d_alp_frac_f64[21] = {
...
__device__ __forceinline__ uint64_t alp_bp_unpack(const uint8_t* bp,
                                                   uint32_t idx,
                                                   uint32_t width)
{
